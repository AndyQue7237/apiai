...
| constrain_image | `scripts/constrain_image.py` | före 8, 15, 18 |
...
> **OBS:** Real-ESRGAN har GPU-gräns på ~2.1MP. Använd `constrain_image.py` med `max_pixels=2000000`
> före upscaler-noder för att resiza ner bilder som är för stora.
>
> `constrain_image.py` stödjer också `max_bytes` för filstorlek (webb-optimering).
