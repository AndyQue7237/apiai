...
| 5 | **Correct Colors** | `image_reference=original` · `auto_crop_reference=true` · `min_coverage=5` · `min_delta_e=10` · `cluster_merge_threshold=8` · `add_edge_border=true` · `border_width=10` |
